import armorsJson from '../mhfu_json/armors.json';
import skillsJson from '../mhfu_json/skills.json';
import skillTreesJson from '../mhfu_json/skill_trees.json';
import decorationsJson from '../mhfu_json/decorations.json';
import tagsJson from '../mhfu_json/tags.json';
...
/** MHFU rarity colors (1-10, from Monster Hunter Wiki). */
